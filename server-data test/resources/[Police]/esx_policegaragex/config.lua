...
Config.ExtraDraw3DText = "Presiona ~g~[E]~s~ para ~y~abrir el menu de Extras~s~"		-- set your desired text here

-- -- Police Cars:
--[[Config.PoliceVehicles = {
	{ model = 'code3camero', label = 'Police Camaro', price = 0 },
	{ model = 'code3mustang', label = 'Police Mustang', price = 0 },
	{ model = 'code3silverado', label = 'Police Silverado', price = 0 },
	{ model = 'code314tahoe', label = 'Police Tahoe', price = 0 },
	{ model = 'code3harley', label = 'Police Harley', price = 0 },
	{ model = 'code3durango', label = 'Police Durango', price = 0 }
}
...
Config.LabelLivery = "Liverys"
Config.TitlePoliceGarage = "Police Garage"
Config.TitlePoliceExtra = "Menu"
Config.TitlePoliceLivery = "Menu"
