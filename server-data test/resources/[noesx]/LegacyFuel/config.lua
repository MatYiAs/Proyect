...
Config.Strings = {
	...
	EToRefuel = "Presiona ~g~E ~w~para respostar el vehiculo",
	JerryCanEmpty = "El bidon esta vacio",
	FullTank = "El tanque esta lleno",
	PurchaseJerryCan = "Presiona ~g~E ~w~para comprar un bidon de gasolina ~g~$" .. Config.JerryCanCost,
	...
	RefillJerryCan = "Presiona ~g~E ~w~ para rellenar el bidon de gasolina ",
	NotEnoughCashJerryCan = "No tienes suficiente dinero para rellenar el bidon de gasolina",
	JerryCanFull = "El bidon esta lleno",
	TotalCost = "Costo",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona ~g~E ~w~para agarrar un bidon de gasolina"
	Config.Strings.RefillJerryCan = "Presiona ~g~E ~w~ para rellenar el bidón de gasolina"
end
