Config = {
    ...
    Locales = {
        ...
        ["drinks"] = "Bebidas",
        ["snacks"] = "Comida",
        ["readymeal"] = "Pre-Cocinado",
        ["diverse"] = "Diversidad   ",
    },

    Items = {
        ["drinks"] = {
            {label = "Agua", item = "water", price = 14},
            {label = "Coca Cola", item = "cocacola", price = 14},
            {label = "Fanta", item = "fanta", price = 14},
            {label = "Sprite", item = "sprite", price = 14},
            {label = "Crush", item = "loka", price = 10},
            {label = "Café", item = "coffee", price = 10},
            {label = "Redbull", item = "redbull", price = 10},
            {label = "Pepsi", item = "pepsi", price = 10},
            {label = "Gatorade", item = "Gatorade", price = 10},
            {label = "Monster", item = "monster", price = 10},
            {label = "whisky", item = "Whisky", price = 17},
            {label = "tequila", item = "Tequila", price = 17},
            {label = "Vodka", item = "vodka", price = 17},
            {label = "Cerveza", item = "beer", price = 8},
            {label = "Powerade", item = "powerade", price = 8},
            {label = "Vino", item = "Wine", price = 17},
        },
        ["snacks"] = {
            {label = "Pan", item = "bread", price = 12},
            {label = "Cheetos", item = "cheesebows", price = 12},
            {label = "Papas Fritas", item = "chips", price = 12},
            {label = "Leche Con Chocolate", item = "marabou", price = 12},
            {label = "HotDog", item = "dog", price = 12},
        },
        ["readymeal"] = {
            {label = "Pizza", item = "pizza", price = 30},
            {label = "Hamburguesa", item = "burger", price = 27},
            {label = "Maruchan", item = "maruchan", price = 12},
            {label = "Sandwich de jamón", item = "macka", price = 8},
            {label = "Papas Fritas", item = "fries", price = 12},
        },
        ["diverse"] = {
            {label = "Cigarros", item = "cigarett", price = 10},
            {label = "Encendedor", item = "lighter", price = 20},
            {label = "Lotería", item = "lotteryticket", price = 20},
        },
    },
}