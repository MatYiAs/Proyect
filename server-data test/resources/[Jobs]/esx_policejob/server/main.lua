...
AddEventHandler('esx_policejob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	elseif itemType == 'item_weapon' then
		...
		if (targetXPlayer.hasWeapon(itemName) == true and sourceXPlayer.hasWeapon(itemName) == false) then
		...
		TriggerClientEvent('esx:showNotification', _source, 'No puedes confiscar este objeto')
		end
	end
end)
