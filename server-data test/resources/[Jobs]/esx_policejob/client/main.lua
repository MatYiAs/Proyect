...
function OpenCloakroomMenu()
	...
	if Config.EnableNonFreemodePeds then
	  ...
	  table.insert(elements, {label = '-= POLICIA NACIONAL =-'})
	  table.insert(elements, {label = 'Uniforme CNP', value = 'segciudadanabase2'}) 
	  table.insert(elements, {label = 'Uniforme Trafico', value = 'gorra1'}) ----editar
	  table.insert(elements, {label = 'Chaleco Antibalas', value = 'casco1'}) ----editar
	  table.insert(elements, {label = 'Chaleco Trafico', value = 'quitarcasco'})
	  table.insert(elements, {label = 'Quitar Chaleco', value = 'chubasquero'})------------------falta por añadir
	  table.insert(elements, {label = '-= ANTIDISTURBIOS =-'})
	  table.insert(elements, {label = 'Uniforme Anti', value = 'quitarchaleco'})
	  table.insert(elements, {label = '-= G.E.O =-'})
	  table.insert(elements, {label = 'Uniforme Manga Corta', value = 'traficobase'})
	  table.insert(elements, {label = 'Uniforme Manga Larga', value = 'traficobase2'})
	  table.insert(elements, {label = 'Pasamontañas', value = 'traficobase3'})
	  table.insert(elements, {label = 'Casco G.E.O', value = 'casco'})
	  table.insert(elements, {label = 'Quitar Casco/Pasamontañas', value = 'quitarpasa'})
	  --table.insert(elements, {label = '-= GEO =-'})
	  --table.insert(elements, {label = 'Uniforme Entero GEO', value = 'ueifull'})
	  --table.insert(elements, {label = '-= UIP =-'})
	  --table.insert(elements, {label = 'Uniforme Base', value = 'grs'})
	  table.insert(elements, {label = '-= SMA =-'})
	  ...
	  ESX.UI.Menu.Open(
		...
		if data.current.value == 'gorra1' then
			...
			if skin.sex == 0 then
				...
				TriggerEvent('skinchanger:change', 'bproof_1', 10)
		...
		if data.current.value == 'desnudo' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
                ...
                --Casco
		if data.current.value == 'casco' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
  
			if skin.sex == 0 then
				TriggerEvent('skinchanger:change', 'helmet_1', 75)
				TriggerEvent('skinchanger:change', 'helmet_2', 0)
			  else
				TriggerEvent('skinchanger:change', 'helmet_1', 75)
				TriggerEvent('skinchanger:change', 'helmet_2', 0)
		...
		-- Casco Moto
		if data.current.value == 'casco1' then
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
		...
		if data.current.value == 'quitarchaleco' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
				TriggerEvent('skinchanger:change', 'tshirt_1', 15)
				TriggerEvent('skinchanger:change', 'tshirt_2', 0)
				TriggerEvent('skinchanger:change', 'torso_1', 53)
				TriggerEvent('skinchanger:change', 'torso_2', 0)
				TriggerEvent('skinchanger:change', 'arms', 30)
				TriggerEvent('skinchanger:change', 'pants_1', 31)
				TriggerEvent('skinchanger:change', 'pants_2', 0)
		...
		if data.current.value == 'ueifull' then --------------------editar
		 ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			local model = nil
  
			if skin.sex == 0 then
			  model = GetHashKey("s_m_y_blackops_01")-------------editar
			else
			  model = GetHashKey("s_m_y_blackops_01")-------------editar
			end
		...
		if data.current.value == 'piloto' then ---------------------editar
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
			  ...
			  TriggerEvent('skinchanger:change', 'helmet_2', 0)
			  TriggerEvent('skinchanger:change', 'chain_1', 33)
			  TriggerEvent('skinchanger:change', 'chain_2', 0)
			  TriggerEvent('skinchanger:change', 'arms', 96)
			else
			  TriggerEvent('skinchanger:change', 'tshirt_1', 15)
			  TriggerEvent('skinchanger:change', 'tshirt_2', 0)
			  TriggerEvent('skinchanger:change', 'torso_1', 59)
			  TriggerEvent('skinchanger:change', 'torso_2', 0)
			  TriggerEvent('skinchanger:change', 'pants_1', 38)
			  TriggerEvent('skinchanger:change', 'pants_2', 1)
			  TriggerEvent('skinchanger:change', 'shoes_1', 24)
			  ...
			  TriggerEvent('skinchanger:change', 'chain_2', 0)
			  TriggerEvent('skinchanger:change', 'arms', 9)
			end
		...
		if data.current.value == 'cinturon1' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
			  TriggerEvent('skinchanger:change', 'tshirt_1', 58)
			  TriggerEvent('skinchanger:change', 'tshirt_2', 0)
			else
			  TriggerEvent('skinchanger:change', 'tshirt_1', 26)
			end
		...
		if data.current.value == 'cinturon2' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
			  TriggerEvent('skinchanger:change', 'tshirt_1', 122)
			  TriggerEvent('skinchanger:change', 'tshirt_2', 0)
			else
			  TriggerEvent('skinchanger:change', 'tshirt_1', 26)
			end
		...
		if data.current.value == 'cinturon3' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
			  TriggerEvent('skinchanger:change', 'tshirt_1', 130)
			  TriggerEvent('skinchanger:change', 'tshirt_2', 0)
			else
			  TriggerEvent('skinchanger:change', 'tshirt_1', 26)
			end
		...
		if data.current.value == 'grs' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
			  model = GetHashKey("s_m_y_swat_01")--------------editar
			else
			  model = GetHashKey("s_m_y_swat_01")--------------editar
			end
		...
		if data.current.value == 'segciudadanabase' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
			  ...
			  TriggerEvent('skinchanger:change', 'pants_1', 33)
			  TriggerEvent('skinchanger:change', 'pants_2', 0)
			  TriggerEvent('skinchanger:change', 'shoes_1', 24)
			  TriggerEvent('skinchanger:change', 'shoes_2', 0)
			else
			  TriggerEvent('skinchanger:change', 'torso_1', 146)
			  TriggerEvent('skinchanger:change', 'torso_2', 0)
			  TriggerEvent('skinchanger:change', 'tshirt_1', 15)
			  TriggerEvent('skinchanger:change', 'tshirt_2', 0)
			  TriggerEvent('skinchanger:change', 'arms', 57)
			  TriggerEvent('skinchanger:change', 'pants_1', 30)
			  TriggerEvent('skinchanger:change', 'pants_2', 0)
			  TriggerEvent('skinchanger:change', 'shoes_1', 26)
			  TriggerEvent('skinchanger:change', 'shoes_2', 0)
		...
		if data.current.value == 'segciudadanabase2' then
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
		...
		if data.current.value == 'chubasquero2' then
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
		...
		if data.current.value == 'traficobase3' then
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			  ...
			  if skin.sex == 0 then
				...
				TriggerEvent('skinchanger:change', 'bproof_1', 30)
				TriggerEvent('skinchanger:change', 'bproof_2', 0)
			  end
		...
		if data.current.value == 'traficobase2' then
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			  ...
			  if skin.sex == 0 then
				...
				TriggerEvent('skinchanger:change', 'mask_2', 25)
				TriggerEvent('skinchanger:change', 'bags_1', 0)
				TriggerEvent('skinchanger:change', 'bags_2', 0)
				TriggerEvent('skinchanger:change', 'glasses_1', 0)
				TriggerEvent('skinchanger:change', 'glasses_2', 0)
		  ...
		  if data.current.value == 'traficobase' then
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			  ...
			  if skin.sex == 0 then
				...
				TriggerEvent('skinchanger:change', 'glasses_1', 0)
				TriggerEvent('skinchanger:change', 'glasses_2', 0)
				TriggerEvent('skinchanger:change', 'bproof_1', 27)
				TriggerEvent('skinchanger:change', 'bproof_2', 0)
			  else
				TriggerEvent('skinchanger:change', 'bproof_1', 30)
				TriggerEvent('skinchanger:change', 'bproof_2', 0)
		...
		if data.current.value == 'armadura1' then
		  ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
			...
			if skin.sex == 0 then
			  TriggerEvent('skinchanger:change', 'bproof_1', 26)
			  TriggerEvent('skinchanger:change', 'bproof_2', 0)
			else
			  TriggerEvent('skinchanger:change', 'bproof_1', 30)
			  TriggerEvent('skinchanger:change', 'bproof_2', 0)
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elseif data.current.value == 'alertas_policiales' then -- Y luego agregas esto, si no sabes no me pidas ayuda, no voy a ayudarte <3
            local elements = {
                {label = "Nivel de Alerta 1", value = 'green'},
                {label = "Nivel de Alerta 2", value = 'yellow'},
                {label = "Nivel de Alerta 3", value = 'orange'},
				{label = "Nivel de Alerta 4", value = 'red'},
				{label = "Quitar Nivel de Alerta", value = 'close'}
            }
            ...
            ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'alertas_policiales', {
                ...
                if action then
					if action == 'close' then
                        TriggerServerEvent('np-alerts:disable')
					else
                        TriggerServerEvent('np-alerts:active', action)    
                    end
                    menu2.close()
                end
            end, function(data2, menu2)
		...
		elseif data.current.value == 'alertas_policiales2' then -- Y luego agregas esto, si no sabes no me pidas ayuda, no voy a ayudarte <3
            local elements = {
				{label = "Policia Disponible", value = 'disponible'},
				{label = "Policia Ocupada", value = 'ocupada'},
				{label = "Quitar Disponibilidad", value = 'close'}
            }

            ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'alertas_policiales2', {
                title    = "Alertas",
                align    = 'bottom-right',
                elements = elements
            }, function(data2, menu2)
                ...
                if action then
					if action == 'close' then
                        TriggerServerEvent('np-alerts2:disable')
					else
                        TriggerServerEvent('np-alerts2:active', action)    
                    end
                    menu2.close()
                end
            end, function(data2, menu2)
